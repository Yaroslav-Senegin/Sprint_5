...
class TestTabsSwitching:
    ...
    def test_go_to_souses(driver):
        ...
        WebDriverWait(driver, 10).until(expected_conditions.visibility_of_element_located(Locators.souses_check))
    ...
    def test_go_to_nachinki(driver):
        ...
        WebDriverWait(driver, 10).until(expected_conditions.visibility_of_element_located(Locators.nachinki_check))
    ...
    def test_go_to_bulki(driver):
        ...
        WebDriverWait(driver, 10).until(expected_conditions.visibility_of_element_located(Locators.bulki_check))
